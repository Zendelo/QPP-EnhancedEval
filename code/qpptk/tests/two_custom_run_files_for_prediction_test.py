...
class TwoCustomRunFilesForPredictionTest(unittest.TestCase):
    ...
    def test_end_to_end_with_run_01(self):
        with tempfile.TemporaryDirectory() as out_dir, tempfile.TemporaryDirectory() as stats_dir:
            ...
            self.assertEqual(actual.iloc[0].to_dict()['clarity+1000+3'], 2.7431934039)
            ...
            self.assertEqual(actual.iloc[1].to_dict()['clarity+1000+3'], 2.3208312544)
            ...
            self.assertEqual(actual.iloc[2].to_dict()['clarity+1000+3'],  2.3616150510000002)
